...
export class EngineModel {
     ...
     */
    static maxClimbThrustTable = [
        [0, 2000, 5000, 8000, 12000, 15000, 17000, 20000, 25000, 27000, 31000, 35000, 39000, 41000],
        [-54.0, 74.6, 76.1, 77.3, 78.9, 80.5, 81.3, 82.5, 83.4, 84.1, 85.5, 87.4, 87.6, 87.3],
        [-50.0, 75.3, 76.8, 78.0, 79.6, 81.2, 82.1, 83.2, 84.1, 84.8, 86.2, 88.2, 88.4, 88.0],
        [-46.0, 76.0, 77.4, 78.7, 80.3, 81.9, 82.8, 83.9, 84.9, 85.6, 87.0, 89.0, 89.1, 88.8],
        [-42.0, 76.6, 78.1, 79.4, 81.0, 82.6, 83.5, 84.6, 85.6, 86.3, 87.7, 89.8, 89.9, 89.5],
        [-38.0, 77.3, 78.8, 80.0, 81.6, 83.3, 84.2, 85.3, 86.4, 87.1, 88.4, 90.5, 90.6, 90.2],
        [-34.0, 77.9, 79.4, 80.7, 82.3, 84.0, 84.9, 86.0, 87.1, 87.8, 89.2, 91.2, 91.3, 91.0],
        [-30.0, 78.6, 80.1, 81.3, 83.0, 84.7, 85.5, 86.7, 87.8, 88.5, 89.9, 91.9, 92.0, 91.7],
        [-26.0, 79.2, 80.7, 82.0, 83.6, 85.4, 86.2, 87.4, 88.4, 89.1, 90.6, 92.7, 92.7, 92.4],
        [-22.0, 79.8, 81.3, 82.6, 84.3, 86.0, 86.9, 88.1, 89.1, 89.8, 91.2, 93.4, 93.5, 93.1],
        [-18.0, 80.4, 82.0, 83.3, 84.9, 86.7, 87.6, 88.7, 89.7, 90.5, 91.9, 94.1, 93.7, 93.4],
        [-14.0, 81.1, 82.6, 83.9, 85.6, 87.3, 88.2, 89.4, 90.4, 91.2, 92.7, 93.9, 93.2, 92.8],
        [-10.0, 81.7, 83.2, 84.6, 86.2, 88.0, 88.8, 90.1, 91.1, 91.9, 93.4, 93.3, 92.7, 92.3],
        [-6.0, 82.3, 83.9, 85.2, 86.9, 88.6, 89.5, 90.7, 91.8, 92.5, 93.6, 92.8, 92.2, 91.9],
        [-2.0, 82.9, 84.5, 85.8, 87.5, 89.3, 90.1, 91.4, 92.4, 93.2, 93.1, 92.4, 91.8, 91.5],
        [2.0, 83.5, 85.1, 86.5, 88.1, 89.9, 90.7, 92.0, 92.8, 92.9, 92.7, 92.0, 91.3, 91.0],
        [6.0, 84.1, 85.7, 87.1, 88.8, 90.6, 91.3, 92.6, 92.5, 92.5, 92.3, 91.5, 90.8, 90.5],
        [10.0, 84.7, 86.3, 87.7, 89.4, 91.2, 92.0, 92.5, 92.1, 92.1, 91.8, 91.1, 90.3, 89.9],
        [14.0, 85.4, 87.0, 88.4, 90.0, 91.8, 91.9, 92.1, 91.7, 91.7, 91.4, 90.5, 89.7, 89.2],
        [18.0, 86.0, 87.6, 89.0, 90.7, 91.4, 91.4, 91.7, 91.3, 91.2, 90.9],
        [22.0, 86.6, 88.2, 89.0, 90.3, 90.9, 91.0, 91.2, 90.7, 90.6, 90.3],
        [26.0, 87.2, 88.5, 88.4, 89.8, 90.4, 90.5, 90.7, 90.1, 90.1, 89.7],
        [30.0, 87.8, 88.0, 87.8, 89.2, 89.9, 90.0, 90.1, 89.5, 89.4],
        [34.0, 87.1, 87.4, 87.2, 88.7, 89.3, 89.4, 89.6, 88.8],
        [38.0, 86.3, 86.6, 86.4, 88.0, 88.7, 88.8, 88.9],
        [42.0, 85.5, 85.7, 85.7, 87.3, 88.0, 88.1],
        [46.0, 84.8, 85.0, 85.0, 86.6, 87.3]
    ];
