    ...
    compute(state: AircraftState, _builder: ProfileBuilder): void {
        ...
        for (const constraint of this.constraints.descentAltitudeConstraints) {
            ...
            this.children.unshift(
                new DescentAltitudeConstraintSegment(this.context, this.constraints, constraint, preferredFlightPathAngle, this.maxSpeed, this.toAltitude, this.useMachVsCas),
            );
        }
    }
